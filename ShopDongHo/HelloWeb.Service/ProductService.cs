...
namespace HelloWeb.Service
{
    public interface IProductService
    {
        ...
        IEnumerable<Product> GetListProducts(int page, int pageSize, string sort, out int totalRow);
    }
    ...
    public class ProductService : IProductService
    {
        ...
        public IEnumerable<Product> GetListProducts(int page, int pageSize, string sort, out int totalRow)
        {
