var cart = {
    ...
    registerEvent: function () {
        ...
        $('.txtQuantity').off('keyup').on('change', function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status) {
                    ...
                    var html = '';
                    var data = res.data;
                    $('#cartShop').html('<sup>' + res.data.length + '</sup>');
                    $.each(data, function (i, item) {
                        html += Mustache.render(template, {
                            ...
                            PriceF: numeral(item.Product.PromotionPrice == null ? item.Product.Price : item.Product.PromotionPrice).format('0,0'),
                            Quantity: item.Quantity,
                            Amount: numeral(item.Quantity * (item.Product.PromotionPrice == null ? item.Product.Price : item.Product.PromotionPrice)).format('0,0')
                        });
                    });
